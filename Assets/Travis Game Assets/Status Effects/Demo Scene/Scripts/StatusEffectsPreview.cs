...
namespace TravisGameAssets
{
    ...
    public class StatusEffectsPreview : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            float scrollInput = mouse.scroll.ReadValue().y * 0.01f;
        ...
        void RefreshStatusUI(int type = -1)
        {
            ...
            {
                case 0:
                    buffsApplyIcon.text = appliedBuffIndex == buffIndex ? checkMark : crossMark;
                    break;

                case 1:
                    debuffsApplyIcon.text = appliedDebuffIndex == debuffIndex ? checkMark : crossMark;
                    break;

                case 2:
                    ailmentsApplyIcon.text = appliedAilmentIndex == ailmentIndex ? checkMark : crossMark;
                    break;
            }
        }
        ...
        public void ToggleSlowMotion()
        {
            ...
            Time.timeScale = slowMotion ? 0.5f : 1.0f;
